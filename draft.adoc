...
Consideraciones generales de las aplicaciones:

- Todas ellas ofrecen un cliente estático HTML (el mismo para todas) bajo la dirección `/` usado únicamente para pruebas iniciales y como depuración.
