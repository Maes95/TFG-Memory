...
image::./design-diagram.png[design, pdfwidth=100%]
...
image::./diagrams/Vertx.jpg[vertx-diagram, pdfwidth=50%]
...
image::./diagrams/VertxNoBus.jpg[vertxnobus, pdfwidth=50%]
...
image::./diagrams/Spring.jpg[spring-diagram, pdfwidth=50%]
...
La aplicación de Node.js (__Figura 24__) es muy sencilla, consta de un servidor en Express que da soporte a un servidor WebSocket proporcionado por la librería ws.
...
__*Los valores de uso de CPU y memoria mostrados en las gráficas corresponden únicamente al proceso maestro.__
...
- Ampliar la aplicación de pruebas para que contemple aplicaciones multiproceso.
